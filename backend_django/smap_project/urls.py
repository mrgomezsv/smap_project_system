...
urlpatterns = [
    ...
    path('product/events/', views.events_list, name='events_list'),
    path('product/events/create/', views.event_detail, name='create_event_new'),
    path('product/events/<int:event_id>/', views.event_detail, name='event_detail_edit'),
    path('product/events/<int:event_id>/delete/', views.delete_event, name='delete_event_new'),
...
if settings.DEBUG:
    ...
    # Soporte para servir media en producción a través de Django (útil para despliegues simples en K8s)
