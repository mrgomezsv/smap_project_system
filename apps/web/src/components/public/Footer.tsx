          ...
          <div className="md:col-span-1">
            ...
            <div className="mt-6 flex gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-9 h-9 rounded-full bg-white/10 hover:bg-brand-yellow/30 flex items-center justify-center transition"
                aria-label="Facebook"
              >
              ...
              <a
                href="https://instagram.com/kidsfunyfiestasinfantiles"
                target="_blank"
                rel="noreferrer"
                className="w-9 h-9 rounded-full bg-white/10 hover:bg-party-pink/30 flex items-center justify-center transition"
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-9 h-9 rounded-full bg-white/10 hover:bg-success/30 flex items-center justify-center transition"
                aria-label="WhatsApp"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <ul className="space-y-2">
                {section.links.map((link) => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="text-sm text-white/70 hover:text-brand-yellow transition"
                    >
                      {link.label}
                    </Link>
                  </li>
