...
ALLOWED_HOSTS = ['kidsfunyfiestasinfantiles.com.webcraftedsolutions.net', '127.0.0.1', 'localhost']
...
CSRF_TRUSTED_ORIGINS = ['https://kidsfunyfiestasinfantiles.com.webcraftedsolutions.net']
