...
# from api.views import ProductListCreate  # Comentado
...
urlpatterns = [
    ...
    path('', include('kidsfun_web.urls_local')),  # Cambia la URL raíz para que redirija a kidsfun/
    ...
    # path('api/products/', ProductListCreate.as_view(), name='product-list'),  # Comentado
    path('kidsfun/', include('kidsfun_web.urls_local')),
    # path('api/', include('api_like.urls')),  # Comentado
    # path('api/', include('api_commentary.urls')),  # Comentado
    # path('api/', include('api_waiver.urls')),  # Comentado
    path('api/v2/', include('waiver_v2.urls')),  # Incluye las URLs de la nueva aplicación waiver_v2
    # path('api_waiver_validator/', include('api_waiver_validator.urls')),  # Comentado
]
